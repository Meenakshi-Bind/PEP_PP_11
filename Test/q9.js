...
let secondletter=words[1][0];
let first_remain=words[0].split(firstletter);
let second_remain=words[1].split(secondletter);
let string=""+secondletter+""+first_remain[1]+" "+""+firstletter+""+second_remain[1];
console.log(string);
