...
document.querySelector(".size").addEventListener('change', function() {
  ...
  document.querySelector(".all-cells").style.fontSize = this.value + "px";
});

document.querySelector(".Fonttype").addEventListener('stroke',function(){
  console.log(this.value);
  document.querySelector(".all-cells").style.fontFamily=this.value+"";
})
